    ...
    try {
        ...
        switch (command) {
            ...
            case 'jooxplay':
                ...
                result = result.result
                caption = `\`❖ Judul   :\` *${result.info.song}*\n`
                caption += `\`❖ Artis :\` *${result.info.singer}*\n`
                caption += `\`❖ Durasi :\` *${result.info.duration}*\n`
                caption += `\`❖ Album    :\` *${result.info.album}*\n`
                caption += `\`❖ Unggahan :\` *${result.info.date}*\n`
                caption += `\`❖ Lirik    :\`\n ${result.lirik}`
            ...
            case 'zippyshare':
                ...
                url = url.result
                text = `\`❖ Nama File    :\` *${url.name_file}*\n`
                text += `\`❖ Ukuran         :\` *${url.size}*\n`
                text += `\`❖ Tanggal Unggahan  :\` *${url.date_upload}*\n`
                text += `\`❖ Url Download :\` *${url.download_url}*`
                await reply(text)
                break
            case 'pinterest':
